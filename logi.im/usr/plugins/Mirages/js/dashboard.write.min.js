...
a+'</h3></p>\n            </div>\n            <form id="mirages-dialog-form">\n                '+b+'\n                <button type="button" class="btn btn-s primary" id="mirages-dialog-btn-submit">\u786e\u5b9a</button>\n                <button type="button" class="btn btn-s" id="mirages-dialog-btn-cancel">\u53d6\u6d88</button>\n            </form>\n        </div>\n    </div>\n</div>'};a._createForm=function(d){for(var b="",p=0;p<d.fields.length;p++){var c=d.fields[p],b=b+('<div class="form-group">\n                <label>'+
c.title+(c.required?"<span style='color: red'>*</span>":"")+":</label>\n");c.type||(c.type="text");if("text"===c.type)b+='<input type="text" name="'+c.name+'" value="'+(c.defaultValue?c.defaultValue:"")+'">';else if("select"===c.type){for(var b=b+('<select name="'+c.name+'">'),h=0;h<c.options.length;h++){var f=c.options[h],g="";c.defaultValue===f&&(g="selected");b+="<option "+g+">"+f+"</option>"}b+="</select>"}else"textarea"===c.type&&(b+='<textarea type="text" name="'+c.name+'" rows="6">'+(c.defaultValue?
a._encodeHTML(c.defaultValue):"")+"</textarea>");b+="</div>"}return a.createDialog(d.title,b)};a.prototype._insertText=function(a){if(document.selection)this.editor.focus(),document.selection.createRange().text=a,this.editor.focus();else if(0<=this.editor.selectionStart){var b=this.editor.selectionStart,d=this.editor.selectionEnd,c=b;this.editor.value=this.editor.value.substring(0,b)+a+this.editor.value.substring(d,this.editor.value.length);c+=a.length;this.editor.focus();this.editor.selectionStart=
c;this.editor.selectionEnd=c}else this.editor.value+=a,this.editor.focus()};a._serializeFormData=function(a){for(var b={},d=0;d<a.length;d++){var c=a[d];if(/^([a-zA-Z0-9]+)\[(\d+)]$/i.test(c.name)){var h=c.name.match(/^([a-zA-Z0-9]+)\[(\d+)]$/i),f=h[1],h=h[2];b[f]||(b[f]=[]);b[f][h]=c.value}else if(/^([a-zA-Z0-9]+)\[(\d+)]\.([a-zA-Z0-9]+)$/i.test(c.name)){var g=c.name.match(/^([a-zA-Z0-9]+)\[(\d+)]\.([a-zA-Z0-9]+)$/i),f=g[1],h=g[2],g=g[3];b[f]||(b[f]=[]);b[f][h]||(b[f][h]={});b[f][h][g]=c.value}else/^([a-zA-Z0-9]+)\.([a-zA-Z0-9]+)$/i.test(c.name)?
(h=c.name.match(/^([a-zA-Z0-9]+)\.([a-zA-Z0-9]+)$/i),f=h[1],h=h[2],b[f]||(b[f]={}),b[f][h]=c.value):b[c.name]=c.value}return b};a._showDialog=function(d){var b=$("body");"function"===typeof d?(b.addClass("dialog-show"),d(b)):(d=a._createForm(d),b.addClass("dialog-show"),b.append(d))};a._hideDialog=function(){var d=$("body");a._removeElement("#mirages-dialog");d.removeClass("dialog-show")};a.triggerDialog=function(d,b){var p=a.buttons[d];if(p){var c=p.form,h=p.doneCallback;c?(a._showDialog(c),$("#mirages-dialog-btn-cancel").off("click").on("click",
function(b){a._hideDialog()}),$("#mirages-dialog-btn-submit").off("click").on("click",function(c){var d=$("#mirages-dialog-form").serializeArray(),d=a._serializeFormData(d);c=h(d,c);"string"===typeof c&&(a._hideDialog(),"function"===typeof b&&b(c))})):(p=h({},e),"function"===typeof b&&b(p))}else console.error("Button: "+d+" not found!")};a.prototype.addButton=function(d,b,p,c,h){var f=this;a.buttons[d]={title:b,icon:p,form:c,doneCallback:h};$(this.container).append('<li class="wmd-button" id="wmd-mirages-'+
d+'-button" title="'+b+'"><i class="fa fa-'+p+'"></i></li>');if(c)$("#wmd-mirages-"+d+"-button").off("click").on("click",function(b){a._showDialog(c);$("#mirages-dialog-btn-cancel").off("click").on("click",function(b){a._hideDialog()});$("#mirages-dialog-btn-submit").off("click").on("click",function(b){var c=$("#mirages-dialog-form").serializeArray(),c=a._serializeFormData(c);b=h(c,b);"string"===typeof b&&(a._hideDialog(),f._insertText(b))})});else $("#wmd-mirages-"+d+"-button").off("click").on("click",
function(b){b=h({},b);f._insertText(b)})};a.prototype.addLinkButton=function(a,b,p,c){$(this.container).append('<li class="wmd-button" id="wmd-mirages-'+a+'-button" title="'+p+'"><a href="'+c+'" target="_blank"><i class="fa fa-'+b+'"/></a></li>')};a.prototype.addSpacer=function(){$(this.container).append('<li class="wmd-spacer" id="wmd-mirages-spacer'+this.spacerIndex+'"></li>');this.spacerIndex++};a.buttons={};var l=function(a,b,p,c){this.targetNode=a;this.classToWatch=b;this.classAddedCallback=
p;this.classRemovedCallback=c;this.observer=null;this.lastClassState=a.classList.contains(this.classToWatch);this.init()};l.prototype.init=function(){var a=this;"undefined"!==typeof MutationObserver&&(this.observer=new MutationObserver(function(b){b=$jscomp.makeIterator(b);for(var d=b.next();!d.done;d=b.next())d=d.value,"attributes"===d.type&&"class"===d.attributeName&&(d=d.target.classList.contains(a.classToWatch),a.lastClassState!==d&&((a.lastClassState=d)?a.classAddedCallback():a.classRemovedCallback()))}),
this.observer.observe(this.targetNode,{attributes:!0}))};l.prototype.disconnect=function(){this.observer&&this.observer.disconnect()};var g=function(d){d.addSpacer();d.addButton("html-video","\u63d2\u5165\u89c6\u9891 (video \u6807\u7b7e)","video-camera",{title:"\u63d2\u5165\u89c6\u9891 (video \u6807\u7b7e)",fields:[{name:"src",title:"\u89c6\u9891\u94fe\u63a5 (\u5efa\u8bae\u4f7f\u7528 MP4 \u683c\u5f0f)",required:!0},{name:"poster",title:"\u89c6\u9891\u5c01\u9762\u56fe\u7247",required:!1},{name:"controls",
...
function(a){return a.src?'\n!!!\n<video src="'+a.src+'" '+("\u663e\u793a"===a.controls?'controls="controls"':"")+" "+(a.poster?'poster="'+a.poster+'"':"")+" "+("\u662f"===a.autoplay?"autoplay":"")+" "+("\u662f"===a.loop?"loop":"")+" "+("\u662f"===a.muted?"muted":"")+" playsinline></video>\n!!!\n":(alert("\u89c6\u9891\u94fe\u63a5\u4e0d\u80fd\u4e3a\u7a7a"),!1)});d.addSpacer();d.addButton("btn","\u77ed\u4ee3\u7801 - \u6309\u94ae\u6837\u5f0f\u7684\u94fe\u63a5","link",{title:"\u63d2\u5165\u77ed\u4ee3\u7801 - \u6309\u94ae\u6837\u5f0f\u7684\u94fe\u63a5",
fields:[{name:"title",title:"\u94fe\u63a5\u540d\u79f0",required:!0},{name:"link",title:"\u94fe\u63a5\u5730\u5740",required:!0}]},function(a){return a.link?'[button href="'+a.link+'"]'+(a.title?a.title:a.link)+"[/button]":(alert("\u94fe\u63a5\u5730\u5740\u4e0d\u80fd\u4e3a\u7a7a"),!1)});d.addButton("tip","\u77ed\u4ee3\u7801 - \u63d0\u793a\u53ca\u8b66\u544a\u6846","exclamation-triangle",{title:"\u63d2\u5165\u77ed\u4ee3\u7801 - \u63d0\u793a\u53ca\u8b66\u544a\u6846",fields:[{name:"type",title:"\u63d0\u793a\u7c7b\u578b",
required:!0,type:"select",options:["info","success","warning","danger"],defaultValue:"info"},{name:"title",title:"\u63d0\u793a\u6807\u9898\uff08\u7528\u4e8e\u52a0\u91cd\u5c55\u793a\uff0c\u53ef\u4e0d\u586b\uff09"},{name:"content",title:"\u63d0\u793a\u5185\u5bb9",required:!0,type:"textarea"}]},function(a){a.content||(a.content="\u63d0\u793a\u5185\u5bb9");return'[tip type="'+a.type+'"'+(a.title?' title="'+a.title+'"':"")+"]\n"+a.content+"\n[/tip]"});d.addButton("file","\u77ed\u4ee3\u7801 - \u4e0b\u8f7d\u6587\u4ef6",
"file-archive-o",{title:"\u63d2\u5165\u77ed\u4ee3\u7801 - \u4e0b\u8f7d\u6587\u4ef6",fields:[{name:"title",title:"\u6587\u4ef6\u540d\u79f0",required:!0},{name:"link",title:"\u6587\u4ef6\u94fe\u63a5\u5730\u5740",required:!0}]},function(a){return a.link?'[file href="'+a.link+'"]'+(a.title?a.title:a.link)+"[/file]":(alert("\u6587\u4ef6\u94fe\u63a5\u5730\u5740\u4e0d\u80fd\u4e3a\u7a7a"),!1)});d.addButton("tag","\u77ed\u4ee3\u7801 - \u6807\u7b7e","tag",{title:"\u63d2\u5165\u77ed\u4ee3\u7801 - \u6807\u7b7e",
...
!1)});d.addButton("hide","\u77ed\u4ee3\u7801 - \u5185\u5bb9\u56de\u590d\u53ef\u89c1","eye-slash",{title:"\u63d2\u5165\u77ed\u4ee3\u7801 - \u5185\u5bb9\u56de\u590d\u53ef\u89c1",fields:[{name:"content",title:"\u5185\u5bb9",required:!0,type:"textarea"}]},function(a){return a.content?"[hide]\n"+a.content+"\n[/hide]":(alert("\u5185\u5bb9\u4e0d\u80fd\u4e3a\u7a7a"),!1)});d.addButton("tab","\u77ed\u4ee3\u7801 - \u6807\u7b7e\u5361","window-maximize",function(b){var d=a.createDialog("\u63d2\u5165\u77ed\u4ee3\u7801 - \u6807\u7b7e\u5361",
'\n<button type="button" class="btn btn-s primary" id="btn-tab-add">\u65b0\u5efa\u6807\u7b7e\u9875</button>\n<div class="content-tabs">\n    <div class="content-tabs-head"></div>\n    <div class="content-tabs-body"></div>\n</div>');b.append(d);var c=1,h=1,f=function(){$(".content-tabs-head").append('<div class="content-tab-title" role="tab" data-tab-index="'+c+'">\u6807\u7b7e\u9875 '+h+"</div>");$(".content-tabs-body").append('\n        <div class="content-tab-content" data-tab-index="'+c+'">\n            <div class="form-group">\n                <label>\u6807\u7b7e\u9875\u540d\u79f0<span style="color: red">*</span>:</label>\n                <input type="text" class="input-tab-title" name="tabs['+
(c-1)+'].title" value="\u6807\u7b7e\u9875 '+h+'">\n            </div>\n            <div class="form-group">\n                <label>\u6807\u7b7e\u9875\u5185\u5bb9<span style="color: red">*</span>:</label>\n                <textarea type="text" class="input-tab-content" name="tabs['+(c-1)+'].content" rows="6"></textarea>\n            </div>\n            <button type="button" class="btn btn-s btn-warn btn-tab-delete">\u5220\u9664\u6b64\u6807\u7b7e\u9875</button>\n        </div>');c++;h++},g=function(){$(".content-tab-title").off("click").on("click",
function(a){var b=$(this),c=b.parent();a=c.parent();var d=b.attr("data-tab-index");a.find(".content-tab-title").each(function(){$(this).attr("data-tab-index")===d?$(this).addClass("selected"):$(this).removeClass("selected")});a.find(".content-tab-content").each(function(){$(this).attr("data-tab-index")===d?$(this).addClass("selected"):$(this).removeClass("selected")});a=c.offset().left;var f=b.offset().left,g=c.innerWidth(),b=b.outerWidth(),h=c.scrollLeft();(function(a){0>a&&(a=0);try{a>c[0].scrollWidth-
c.innerWidth()&&(a=c[0].scrollWidth-c.innerWidth())}catch(E){console.error(E)}c.animate({scrollLeft:a},500)})(f+h-a-(g-b)/2)});$(".btn-tab-delete").off("click").on("click",function(a){if(confirm("\u786e\u5b9a\u8981\u5220\u9664\u6b64\u6807\u7b7e\u9875\u5417\uff1f")){a=$(this).parent();var b=a.parent().parent(),d=parseInt(a.attr("data-tab-index")),f=d-1;1>=d&&(f=d+1);b.find(".content-tab-title").each(function(){var a=parseInt($(this).attr("data-tab-index"));a===f?$(this).addClass("selected"):a===d?
$(this).remove():$(this).removeClass("selected")});b.find(".content-tab-content").each(function(){var a=parseInt($(this).attr("data-tab-index"));a===f?$(this).addClass("selected"):a===d?$(this).remove():$(this).removeClass("selected")});c=1;b.find(".content-tab-title").each(function(a){a+2>c&&(c=a+2);var d=$(this),f=parseInt(d.attr("data-tab-index"));d.attr("data-tab-index",a+1);if(d=b.find(".content-tab-content[data-tab-index="+f+"]"))d.attr("data-tab-index",a+1),d.find(".input-tab-title").attr("name",
"tabs["+a+"].title"),d.find(".input-tab-content").attr("name","tabs["+a+"].content")})}});$(".input-tab-title").off("input propertychange").on("input propertychange",function(a){var b=$(this),c=b.parents(".content-tab-content");a=c.parent().parent();c=parseInt(c.attr("data-tab-index"));b=b.val();0>=b.length&&(b="\u6807\u7b7e\u9875");a.find(".content-tab-title[data-tab-index="+c+"]").text(b)})};f();f();$('.content-tab-title[data-tab-index="1"]').addClass("selected");$('.content-tab-content[data-tab-index="1"]').addClass("selected");
g();$("#btn-tab-add").off("click").on("click",function(a){f();g();$('.content-tab-title[data-tab-index="'+(c-1)+'"]').trigger("click")})},function(a){a=a.tabs;if(!a||0>=a.length)return alert("\u6ca1\u6709\u521b\u5efa\u6807\u7b7e\u9875"),!1;var b="";[].forEach.call(a,function(a){a.title||(a.title="\u6807\u7b7e\u9875");a.content||(a.content="\u6807\u7b7e\u9875\u5185\u5bb9");b+='[tab title="'+a.title+'"]\n'+a.content+"\n[/tab]\n\n"});return"[tabs]\n\n"+b+"[/tabs]\n"});d.addButton("collapse","\u77ed\u4ee3\u7801 - \u6298\u53e0\u6846",
...
!1):(alert("\u6298\u53e0\u6846\u6807\u9898\u4e0d\u80fd\u4e3a\u7a7a"),!1)});d.addButton("github","\u77ed\u4ee3\u7801 - Github Repo","github",{title:"\u63d2\u5165\u77ed\u4ee3\u7801 - Github Repo",fields:[{name:"repo",title:"Github Repo",required:!0}]},function(a){if(!a.repo)return alert("Github Repo \u4e0d\u80fd\u4e3a\u7a7a"),!1;a=a.repo;var b=a.match(/^(http|https):\/\/github.com\/([^\/]+\/[^\/]+)$/);b&&(a=b[2]);return'[github repo="'+a+'" /]'});d.addLinkButton("shortcode-doc","question-circle-o",
"\u77ed\u4ee3\u7801\u4f7f\u7528\u8bf4\u660e","https://get233.com/archives/mirages-shortcode-docs.html")},n=function(a){if("undefined"===typeof Pinyin)return a;var b="";a=Pinyin.parse(a);for(var d=0;d<a.length;d++){var c=a[d],g=c.type;(1===g||2===g)&&(c=c.target)&&(b+=c.toLowerCase())}return b},k=null,x=function(){var d=!1,b=setTimeout(function(){alert("Vditor \u521d\u59cb\u5316\u5931\u8d25")},1E4),g=null,c=$("#text"),h=c.height(),f=$("#title").parent().width(),x=c.val(),A=$("#wmd-editarea");A.after('<div id="vditor"></div>');
var r=$('form[name="write_post"],form[name="write_page"]').attr("action"),r=new URL(r),q=$('input[name="cid"]').val(),y=LocalConst.BASE_UPLOAD_URL;y||(y=""+r.origin+LocalConst.REWRITE_FIX+"/action/upload"+r.search);var y=y+("&cid="+q),B={},C=[],G=function(a){var b=k.getSelection();b&&0<b.length?k.updateValue(a):k.insertValue(a)},H=function(){if(k){var a=k.getValue();A.val(a)}};window.allowSubmitFormInVditor=function(a){if(!d)return!1;H();return!0};var E=function(){try{$(".post-content table").wrap("<div class='table-responsive'></div>"),
...
mode:q,toolbar:r,toolbarConfig:{pin:!0},tab:"    ",after:function(){clearTimeout(b);A.hide();$("#wmd-button-bar").hide();var a=$("#vditor");a.css("display","");$('a[href="#tab-files"]').parent().hide().prev().removeClass("w-50").addClass("w-100");$("form[name=write_post],form[name=write_page]").attr("onsubmit","return allowSubmitFormInVditor(this)");$("#btn-submit, #btn-save").on("click",function(a){d=!0});var c=document.querySelector("#vditor");new l(c,"vditor--fullscreen",function(){$("body").css("overflow-y",
