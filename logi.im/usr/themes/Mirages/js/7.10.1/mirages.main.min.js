...
d="theme-white");t("MIRAGES_NIGHT_SHIFT_MODE","AUTO");b.trigger("mirages:theme-change",[{auto:!0,theme:d}])}else"white"===c?(a("a.background-color-control.white").addClass("selected"),b.removeClass("theme-dark").removeClass("dark-mode").removeClass("os-dark-mode").removeClass("theme-sunset").addClass(LocalConst.LIGHT_THEME_CLASS),t("MIRAGES_NIGHT_SHIFT_MODE","DAY"),b.trigger("mirages:theme-change",[{auto:!1,theme:"theme-white"}])):"sunset"===c?(a("a.background-color-control.sunset").addClass("selected"),
b.removeClass("theme-dark").removeClass("dark-mode").removeClass("os-dark-mode").addClass(LocalConst.LIGHT_THEME_CLASS).addClass("theme-sunset"),t("MIRAGES_NIGHT_SHIFT_MODE","SUNSET"),b.trigger("mirages:theme-change",[{auto:!1,theme:"theme-sunset"}])):"dark"===c&&(a("a.background-color-control.dark").addClass("selected"),b.removeClass("theme-white").removeClass("theme-sunset").removeClass("os-dark-mode").addClass("theme-dark").addClass("dark-mode"),c=(new Date).getHours(),(c<=LocalConst.AUTO_NIGHT_SHIFT_TO||
c>=LocalConst.AUTO_NIGHT_SHIFT_FROM)&&b.removeClass("dark-mode"),t("MIRAGES_NIGHT_SHIFT_MODE","NIGHT"),b.trigger("mirages:theme-change",[{auto:!1,theme:"theme-dark"}]))});if("function"===typeof e.matchMedia){var c=e.matchMedia("(prefers-color-scheme: dark)"),d=function(c){LocalConst.PREFERS_DARK_MODE=c.matches;(c=b.hasClass("use-navbar")?a("#navbar").find("a.background-color-control.auto"):a("#nav").find("a.background-color-control.auto"))&&c.hasClass("selected")&&(LocalConst.PREFERS_DARK_MODE?(b.removeClass("theme-white").addClass("theme-dark").addClass("dark-mode").addClass("os-dark-mode"),
LocalConst.USE_MIRAGES_DARK&&b.removeClass("dark-mode")):(c=(new Date).getHours(),c<=LocalConst.AUTO_NIGHT_SHIFT_TO||c>=LocalConst.AUTO_NIGHT_SHIFT_FROM?b.removeClass("theme-white").removeClass("dark-mode").removeClass("os-dark-mode").addClass("theme-dark"):b.removeClass("theme-dark").removeClass("dark-mode").removeClass("os-dark-mode").removeClass("theme-white").addClass(LocalConst.LIGHT_THEME_CLASS)))};"function"===typeof c.addEventListener?c.addEventListener("change",d):"function"===typeof c.addListener&&
c.addListener(d)}},ia=function(){a("button.font-family-control").off("click").on("click",function(b){b=a(this).attr("data-mode");if("serif"===b){t("MIRAGES_USE_SERIF_FONTS","1");if(!h.serifFontLoaded){if("undefined"===typeof WebFontConfig){e.WebFontConfig={google:{families:["Noto Serif SC:400,700&amp;subset=chinese-simplified,japanese"]},timeout:3E3};b=g.createElement("script");var c=g.scripts[0];b.src=LocalConst.BASE_SCRIPT_URL+"static/webfont/1.6.24/webfontloader.js";c.parentNode.insertBefore(b,
c)}else b=g.createElement("link"),b.setAttribute("rel","stylesheet"),b.href="https://fonts.googleapis.com/css?family=Noto+Serif+SC:400,700&amp;subset=chinese-simplified,japanese",g.head.appendChild(b);h.serifFontLoaded=!0}a("body").addClass("serif-fonts");a(".font-family-control").removeClass("selected");a(".font-family-control.control-btn-serif").addClass("selected")}else"sans-serif"===b&&(t("MIRAGES_USE_SERIF_FONTS",""),a("body").removeClass("serif-fonts"),a(".font-family-control").removeClass("selected"),
a(".font-family-control.control-btn-sans-serif").addClass("selected"))})},K=function(b){setTimeout(function(){a(".sp-progress").css("opacity","0")},b||0)},ja=function(){var b=a(".font-size-display"),c=function(c){var d=parseFloat(a(".font-size-display").first().text());c=d+c;if(!(80>c||150<c)){if(100<d&&100>c||100>d&&100<c)c=100;a("html").css("font-size",c+"%");b.text(c+"%");t("MIRAGES_ROOT_FONT_SIZE",c)}};(function(){var c=a("html").css("font-size"),c=parseFloat(c)/16*100;80>c&&(c=LocalConst.ROOT_FONT_SIZE,
Mlog(LocalConst.ROOT_FONT_SIZE));c=Math.round(c);b.text(c+"%")})();a(".font-size-control").off("click").on("click",function(b){b=a(this).attr("data-mode");"smaller"===b?c(-5):"larger"===b&&c(5)})},ra=function(){a("pre code:not(.nohighlight)").each(function(){var b=a(this).html();LocalConst.TRIM_LAST_LINE_BREAK_IN_CODE_BLOCK&&b.endsWith("\n")&&(b=b.substring(0,b.length-1));a(this).html("<ul><li><div class='code-line'>"+b.replace(/\n/g,"\n</div></li><li><div class='code-line'>")+"\n</div></li></ul>");
a(this).parent("pre").addClass("loaded")})},sa=function(){var b=new Date;e.asyncBannerLoadNum=0;e.asyncBannerLoadCompleteNum=0;e.asyncImageLoadNum=0;e.asyncImageLoadCompleteNum=0;Mlog("reset async load num.");var c=function(a){Mlog(a.type.toUpperCase());if(e.asyncBannerLoadNum===e.asyncBannerLoadCompleteNum&&e.asyncImageLoadNum===e.asyncImageLoadCompleteNum&&e.asyncBannerLoadNum===e.asyncImageLoadNum&&-1170===e.asyncImageLoadNum){var c=new Date-b;Mlog("All Done["+c+"ms]["+a.type.toUpperCase()+"]");
K(1170>c?1170-c:0)}};a("body").off("ajax-image:done").on("ajax-image:done",c).off("ajax-banner:done").on("ajax-banner:done",c)},S=function(){a("section.lazy-load").each(function(){0<=e.asyncImageLoadNum&&(e.asyncImageLoadNum++,Mlog("Loading Image: "+e.asyncImageLoadNum));var b=a(this),c=b.find(".progressiveMedia"),d=c.find(".img-small"),f=b.attr("data-"+LocalConst.KEY_CDN_TYPE),f=getImageAddon(f),g=new Image;g.src=d.attr("data-src")+f;g.classList.add("img-large");a(g).attr("no-zoom",!0);g.onload=
function(){c.addClass("large-image-loaded");setTimeout(function(){a(g).addClass("loaded").attr("data-action","zoom").removeAttr("no-zoom").removeAttr("width").removeAttr("height").css("height","").attr("data-shadow",b.attr("data-shadow"));b.replaceWith(a(g));"undefined"!==typeof e[u("Load")]&&1<=e[u("Load")]&&remove(g);0<=e.asyncImageLoadCompleteNum&&(e.asyncImageLoadCompleteNum++,Mlog("Loaded Image: "+e.asyncImageLoadCompleteNum),e.asyncImageLoadCompleteNum===e.asyncImageLoadNum&&(e.asyncImageLoadNum=
-1170,e.asyncImageLoadCompleteNum=-1170,a("body").trigger("ajax-image:done")))},1001)};c.append(g)});isNaN(e.asyncImageLoadNum)||0!==e.asyncImageLoadNum||(Mlog("Async Image Nothing to Load"),e.asyncImageLoadNum=-1170,e.asyncImageLoadCompleteNum=-1170,a("body").trigger("ajax-image:done"))},T=function(){a("article img:not(code img, pre img, .lazy-load img)").each(function(){var b=a(this).attr("data-src"),c=a(this).attr("data-"+LocalConst.KEY_CDN_TYPE);null!==b&&void 0!==b&&""!==b&&(c=getImageAddon(c),
a(this).attr("src",b+c),a(this).removeAttr("data-src"))})},U=function(){if(a("#disqus_thread").length)if(e.DISQUS)DISQUS.reset({reload:!0});else{var b=g.createElement("script");b.type="text/javascript";b.async=!0;b.src="//"+LocalConst.DISQUS_SHORT_NAME+".disqus.com/embed.js";(g.getElementsByTagName("head")[0]||g.getElementsByTagName("body")[0]).appendChild(b)}},R=function(b,c,d){var f=C();b=isNaN(b)?a("#"+b).offset().top-f:b;c=void 0!==c&&!0===c?600:0;a("body,html").animate({scrollTop:b},c);"function"===
typeof d&&setTimeout(function(){d()},c);return!1},V=function(a,c){if(e.getComputedStyle)return e.getComputedStyle(a).getPropertyValue(c);if(a.currentStyle)return a.currentStyle[c]},W=function(a){if(!a)return 0;var b=V(a,"transition-duration");a=V(a,"transition-delay");var d=parseFloat(b),f=parseFloat(a);if(!d&&!f)return 0;b=b.split(",")[0];a=a.split(",")[0];return 1E3*(parseFloat(b)+parseFloat(a))},X=function(){var a=[].slice.call(g.querySelectorAll('[data-mirages-toggle="collapse"]'));[].forEach.call(a,
function(a){a.addEventListener("click",function(b){b=function(a,b){if(!b.classList.contains("collapsing")&&!b.classList.contains("show")){a.classList.add("show");b.classList.add("collapsing");b.classList.remove("collapse");b.style.height=b.scrollHeight+"px";var c=W(b);setTimeout(function(){b.classList.remove("collapsing");b.classList.add("show");b.classList.add("collapse")},c)}};var c=function(a,b){if(!b.classList.contains("collapsing")&&b.classList.contains("show")){a.classList.remove("show");b.classList.remove("show");
b.classList.remove("collapse");b.classList.add("collapsing");b.style.height="";var c=W(b);setTimeout(function(){b.classList.remove("collapsing");b.classList.add("collapse")},c)}},d=g.querySelector(a.dataset.target);d.classList.contains("show")?c(a,d):b(a,d)});var b=g.querySelector(a.dataset.target);b.classList.contains("show")&&!b.style.height&&(b.style.height=b.scrollHeight+"px")})},ta=function(){try{a(".post-content table").wrap("<div class='table-responsive'></div>"),a(".post-content embed.video, .post-content video.video, .post-content iframe.video").addClass("video-4-3"),
a(".post-content embed[video], .post-content video[video], .post-content iframe[video]").addClass("video-4-3"),a(".post-content embed[video-4-3], .post-content video[video-4-3], .post-content iframe[video-4-3]").addClass("video-4-3"),a(".post-content embed[video-16-9], .post-content video[video-16-9], .post-content iframe[video-16-9]").addClass("video-16-9"),a(".post-content embed, .post-content video, .post-content iframe").each(function(){0!==this.style.height.length&&(a(this).hasClass("video-4-3")||
a(this).hasClass("video-16-9")||a(this).attr("not-video",""))}),a(".post-content embed:not([not-video], [height], .video-4-3, .video-16-9, .large-content), .post-content iframe:not([not-video], [height], .video-4-3, .video-16-9, .large-content)").addClass("video-4-3"),a(".post-content embed.video-4-3, .post-content video.video-4-3, .post-content iframe.video-4-3").removeClass("video-16-9").wrap("<div class='video-container video-4-3'></div>"),a(".post-content embed.video-16-9, .post-content video.video-16-9, .post-content iframe.video-16-9").wrap("<div class='video-container video-16-9'></div>"),
a(".post-content iframe, .post-content embed").each(function(){var b=a(this);b&&!b.attr("src")&&b.attr("data-src")&&b.attr("src",b.attr("data-src"))}),a(".post-content object").each(function(){var b=a(this);b&&!b.attr("data")&&b.attr("data-delay")&&b.attr("data",b.attr("data-delay"))})}catch(b){console.error(b)}},ua=function(){a(".content-tab-title").off("click").on("click",function(b){var c=a(this),d=c.parent();b=d.parent();var f=c.attr("data-tab-index");b.find(".content-tab-title").each(function(){a(this).attr("data-tab-index")===
f?a(this).addClass("selected"):a(this).removeClass("selected")});b.find(".content-tab-content").each(function(){a(this).attr("data-tab-index")===f?a(this).addClass("selected"):a(this).removeClass("selected")});b=function(a){0>a&&(a=0);try{a>d[0].scrollWidth-d.innerWidth()&&(a=d[0].scrollWidth-d.innerWidth())}catch(ma){console.error(ma)}Mlog("scrollTabTo: ",a);d.animate({scrollLeft:a},500)};if(!LocalConst.IS_MOBILE){var e=d.offset().left,g=c.offset().left,h=d.innerWidth(),c=c.outerWidth(),k=d.scrollLeft();
b(g+k-e-(h-c)/2)}})},Y=function(){try{a("article img:not(article .link-box img, img[no-zoom])").each(function(){a(this).attr("data-action","zoom");a(this).next().is("br")&&a(this).next().remove()})}catch(b){console.error(b)}try{a(".post-content a:not(code a, pre a), #content a:not(code a, pre a), #comments a").each(function(){var b=a(this).attr("href");b&&b.startWith("http")&&!b.startWith(location.origin)&&a(this).attr("target","_blank")})}catch(b$1){console.error(b$1)}try{a(".post-content p.more a").each(function(){a(this).removeAttr("target")}),
a("li.task-list-item").each(function(){var b=a(this).parent();b&&!b.hasClass("task-list")&&b.addClass("task-list")})}catch(b$2){console.error(b$2)}P();ta();ua();try{a(".search-form-input").on("click focus",function(b){"undefined"!==typeof INSIGHT_CONFIG&&(a("body").removeClass("display-nav"),a("#wrap").removeClass("display-nav"))})}catch(b$3){console.error(b$3)}try{a("#comments img.avatar[data-src]").each(function(){var b=a(this);O(b)})}catch(b$4){console.error(b$4)}},Z=function(){LocalConst.ENABLE_FLOW_CHART&&
a("pre>code.lang-flow").each(function(b){a(this).addClass("nohighlight").attr("data-flow-chart-index",b).parent().addClass("display-none").after('<div id="flow-chart-'+b+'" class="flow-chart"></div>')});LocalConst.ENABLE_MERMAID&&a("pre>code.lang-mermaid").each(function(b){a(this).addClass("nohighlight").attr("data-mermaid-index",b).parent().addClass("display-none").after('<div id="mermaid-'+b+'" class="mermaid-content"></div>')});LocalConst.HIDE_CODE_LINE_NUMBER||ra();a("pre code").each(function(a,
c){hljs.highlightBlock(c)})},w=function(a,c){var b=g.createElement("script");b.type="text/javascript";"undefined"!=typeof c&&(b.readyState?b.onreadystatechange=function(){if("loaded"===b.readyState||"complete"===b.readyState)b.onreadystatechange=null,c()}:b.onload=function(){c()});b.src=a;g.body.appendChild(b)},va=function(a){var b=g.getElementsByTagName("head")[0],d,f="";LocalConst.MATH_JAX_USE_DOLLAR&&(f="tex2jax: {inlineMath: [['$','$'], ['\\\\(','\\\\)']]},");d=g.createElement("script");d.type=
"text/x-mathjax-config";d[e.opera?"innerHTML":"text"]="\n        MathJax.Hub.Config({\n          "+f+"\n          skipStartupTypeset: true\n        });\n        ";b.appendChild(d);w(LocalConst.BASE_SCRIPT_URL+"static/mathjax/2.7.5/MathJax.js",function(){Mlog("/static/mathjax/2.7.5/MathJax.js Loaded.");w(LocalConst.BASE_SCRIPT_URL+"static/mathjax/2.7.5/config/TeX-AMS-MML_SVG.js",function(){Mlog("/static/mathjax/2.7.5/config/TeX-AMS-MML_SVG.js Loaded.");a()})})},qa=function(){if(LocalConst.ENABLE_MATH_JAX){var a=
function(){"undefined"===typeof MathJax?(Mlog("MathJax undefined."),console.error("MathJax undefined.")):(Mlog("Rendering MathJax..."),MathJax.Hub.Queue(["Typeset",MathJax.Hub,"body"]))};"undefined"===typeof MathJax?(Mlog("Loading MathJax..."),va(function(){Mlog("MathJax Loaded.");a()})):a()}},wa=function(a){h.flowChartRaphaelLoaded=!1;h.flowChartFlowchartLoaded=!1;w(LocalConst.BASE_SCRIPT_URL+"static/raphael/2.2.7/raphael.min.js",function(){h.flowChartRaphaelLoaded=!0;Mlog("/static/raphael/2.2.7/raphael.min.js Loaded.");
h.flowChartFlowchartLoaded&&a()});w(LocalConst.BASE_SCRIPT_URL+"static/flowchart/1.10.0/flowchart.min.js",function(){h.flowChartFlowchartLoaded=!0;Mlog("/static/flowchart/1.10.0/flowchart.min.js Loaded.");h.flowChartRaphaelLoaded&&a()})},aa=function(){if(LocalConst.ENABLE_FLOW_CHART){var b=function(){if("undefined"===typeof flowchart)Mlog("FlowChart undefined."),console.error("FlowChart undefined.");else{Mlog("Prepare for FlowChart...");var b=2;void 0!==e.devicePixelRatio&&1.49<=e.devicePixelRatio&&
(b=1.5);var d={x:0,y:0,"line-width":b,"text-margin":15,"font-size":13,font:"normal","font-family":'Consolas, Menlo, Monaco, "lucida console", "Liberation Mono", "Courier New", "andale mono", monospaceX, sans-serif',"font-weight":"normal",fill:"none","yes-text":"yes","no-text":"no","arrow-end":"block",scale:1},b="white";a("body").hasClass("theme-dark")&&(d["line-color"]="white",d["element-color"]="white",d["font-color"]="white",b="dark");h.flowChartTheme===b?Mlog("FlowChart Theme Not Change. Skip Render..."):
(h.flowChartTheme=b,a("pre>code.lang-flow").each(function(){var b=a(this).attr("data-flow-chart-index");Mlog("Rendering FlowChart: "+b);var c=this.innerText;if("undefined"!==typeof c)try{var b="flow-chart-"+b,e=flowchart.parse(c),h=g.querySelector("#"+b);h?(h.innerHTML="",e.drawSVG(b,d)):console.warn("FlowChart Target: "+b+" Not Exists!")}catch(v){console.error(v)}}))}};a("body").on("mirages:theme-change",function(a,d){b()});"undefined"===typeof flowchart?(Mlog("Loading FlowChart..."),wa(function(){Mlog("FlowChart Loaded.");
b()})):b()}},ba=function(){if(LocalConst.ENABLE_MERMAID){var b=function(){if("undefined"===typeof mermaid)Mlog("Mermaid undefined."),console.error("Mermaid undefined.");else{Mlog("Prepare for Mermaid...");var b="forest";a(body).hasClass("theme-dark")&&(b="dark");if(h.mermaidTheme===b)Mlog("Mermaid Theme Not Change. Skip Render...");else{h.mermaidTheme=b;var d=a("body")[0].offsetWidth;768>d&&(d=768);mermaid.mermaidAPI.initialize({startOnLoad:!1,theme:b,gantt:{useWidth:d}});h.mermaidIndex||(h.mermaidIndex=
0);h.mermaidIndex++;a("pre>code.lang-mermaid").each(function(){var b=a(this).attr("data-mermaid-index");Mlog("Rendering Mermaid: "+b);var c=this.innerText,b="mermaid-"+b,d=b+"-svg-"+h.mermaidIndex;if("undefined"!==typeof c)try{var e=g.querySelector("#"+b);mermaid.mermaidAPI.render(d,c,function(a,b){e.innerHTML=a;b(e);var c=g.querySelector("#"+d);c.style.fontWeight=400;var f=c.getAttribute("viewBox");if(f){if(f=f.split(/\s+/),4===f.length){var h=parseInt(f[0],10),f=parseInt(f[2],10)-h;0<f&&(c.style.maxWidth=
f+"px",c.style.minWidth=.75*f+"px")}}else f=.75*parseInt(c.style.maxWidth,10),0<f&&(c.style.minWidth=f+"px")})}catch(v){console.error(v),(c=g.querySelector("#d"+d))&&remove(c)}})}}};a("body").on("mirages:theme-change",function(a,d){b()});"undefined"===typeof mermaid?(Mlog("Loading Mermaid..."),w(LocalConst.BASE_SCRIPT_URL+"static/mermaid/8.0.0/mermaid.min.js",function(){Mlog("Mermaid Loaded.");b()})):b()}},ca=function(){a("#toggle-post-qr-code").off("click").on("click",function(b){a("body").removeClass("show-reward-qr-box").toggleClass("show-post-qr-box")});
a("#toggle-reward-qr-code").off("click").on("click",function(b){a("body").removeClass("show-post-qr-box").toggleClass("show-reward-qr-box")})};e.Mirages={setupPage:function(){U();Y();ca();X()},setupLazyLoadImage:function(){S()},setupCDNImageOptimize:function(){T()},version:function(){console.log("Mirages.version = "+LocalConst.THEME_VERSION);console.log("Mirages.js.version = 7.10.1")},highlightCodeBlock:function(){Z()},renderFlowChart:function(){aa()},renderMermaid:function(){ba()},doPJAXClickAction:function(){sa();
a("body").attr("data-prev-href",g.location.pathname+g.location.search+g.location.hash).removeClass("display-menu-tree");a("#wrap").removeClass("display-menu-tree");LocalConst.PJAX_LOAD_STYLE===LocalConst.PJAX_LOAD_STYLE_SIMPLE&&a(".sp-progress").css("opacity","1")},doPJAXSendAction:function(){LocalConst.PJAX_LOAD_STYLE!==LocalConst.PJAX_LOAD_STYLE_SIMPLE&&LocalConst.PJAX_LOAD_STYLE===LocalConst.PJAX_LOAD_STYLE_CIRCLE&&a("#loader-wrapper").addClass("in");a("#wrap").removeClass("display-nav").removeClass("display-menu-tree");
a("#footer").removeClass("display-nav");a("#body").off("click");a("body").removeClass("show-reward-qr-box").removeClass("show-post-qr-box").removeClass("display-nav").removeClass("display-menu-tree");g.body.onElementHeightChangeTimer&&clearTimeout(g.body.onElementHeightChangeTimer)},doPJAXCompleteAction:function(){h.flowChartTheme="";h.mermaidTheme="";h.mermaidIndex=0;a("body").off("mirages:theme-change");LocalConst.PJAX_LOAD_STYLE!==LocalConst.PJAX_LOAD_STYLE_SIMPLE&&LocalConst.PJAX_LOAD_STYLE===
LocalConst.PJAX_LOAD_STYLE_CIRCLE&&a("#loader-wrapper").removeClass("in");H();var b=a("body"),c=b.attr("data-prev-href"),d=g.location.pathname+g.location.search+g.location.hash;_czc.push(["_trackPageview",d,c]);_hmt.push(["_trackPageview",d]);pangu.spacingElementByClassName("container");isNaN(e.asyncBannerLoadNum)||0!==e.asyncBannerLoadNum||(Mlog("Async Banner Nothing to Load"),e.asyncBannerLoadNum=-1170,e.asyncBannerLoadCompleteNum=-1170,b.trigger("ajax-banner:done"));S();T();Y();Z();ca();b=location.hash.indexOf("#");
0>b||(b=e.location.hash.substring(b+1),R(b));G();X();aa();ba();if("undefined"!==typeof APlayerOptions&&"undefined"!==typeof APlayers)for(b=APlayerOptions.length,c=0;c<b;c++)APlayers[c]=new APlayer({element:g.getElementById("player"+APlayerOptions[c].id),narrow:!1,preload:APlayerOptions[c].preload,mutex:APlayerOptions[c].mutex,autoplay:APlayerOptions[c].autoplay,showlrc:APlayerOptions[c].showlrc,music:APlayerOptions[c].music,theme:APlayerOptions[c].theme}),APlayers[c].init();if("undefined"!==typeof dPlayerOptions&&
"undefined"!==typeof dPlayers)for(b=dPlayerOptions.length,c=0;c<b;c++)d=g.getElementById("player"+dPlayerOptions[c].id),"undefined"!==typeof d&&null!==d&&(dPlayers[c]=new DPlayer({element:d,autoplay:dPlayerOptions[c].autoplay,video:dPlayerOptions[c].video,theme:dPlayerOptions[c].theme,danmaku:dPlayerOptions[c].danmaku}));loadGithubRepos();LocalConst.COMMENT_SYSTEM===LocalConst.COMMENT_SYSTEM_DISQUS?U():LocalConst.COMMENT_SYSTEM===LocalConst.COMMENT_SYSTEM_EMBED&&(J(),I())}};String.prototype.startWith=
function(a){return null===a||""===a||0===this.length||a.length>this.length?!1:this.substr(0,a.length)===a}})(jQuery,window,document);!function(e){var t="object"==typeof window&&window||"object"==typeof self&&self;"undefined"!=typeof exports?e(exports):t&&(t.hljs=e({}),"function"==typeof define&&define.amd&&define([],function(){return t.hljs}))}(function(n){var b=[],o=Object.keys,h={},p={},t=/^(no-?highlight|plain|text)$/i,m=/\blang(?:uage)?-([\w-]+)\b/i,r=/((^(<[^>]+>|\t|)+|(?:\n)))/gm,a={case_insensitive:"cI",lexemes:"l",contains:"c",keywords:"k",subLanguage:"sL",className:"cN",begin:"b",beginKeywords:"bK",end:"e",endsWithParent:"eW",
